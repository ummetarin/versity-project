...
<div class="max-w-sm bg-white border  border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="rounded-t-lg w-full h-[350px]" src="<?php echo $app_im; ?>" alt="" />
    </a>
    <div class="p-5">
        <a href="#">
        ...
        <p class="mb-3 font-medium  pb-2 text-xl   text-amber-900"><?php echo $app_ti; ?></p>
   ...
   <h1 class="text-xl font-bold ">$<?php echo $app_pr ?></h1>
        ...
        <a href="./MenuDet.php?app_id=<?php echo $app_id ?>" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-orange-900 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Details
