...
<body>
   ...
   <?php
    ...
    ?>
     ...
     <div>
      <div>
        <img class="about h-[500px] w-full" src="https://i.ibb.co/9pGJYZx/l-intro-1655317922.jpg" alt="">
      </div>
    ...
    <!-- loca -->
       <div>
        <h1 class="text-center text-3xl  font-bold py-1 text-pink-500 py-4 pt-24">Location Our Shop</h1>
        ...
        <div class="flex md:flex-row flex-col justify-center mx-auto gap-12 py-12 items-center ">
          ...
          <div>
            <img class="w-[550px] rounded-lg " src="https://i.ibb.co/KjMYpFK/1-4-780x520.jpg" alt="">
          </div>
        </div>
 ...
 <!-- roll -->
 <div>
  <h1 class="text-3xl pt-12 font-bold text-center text-pink-500 py-3">Speacilities Our Shop</h1>
  
  <div class="flex md:flex-row flex-col justify-center items-center  gap-24 py-12 ">
    <div>
      <img class="w-[550px] rounded-lg " src="https://i.ibb.co/0j2b7kg/l-intro-1689289386.jpg" alt="">
    </div>
